...
<body>
    <div style="background-color:#FFF;height:10px;opacity:0.7;width:1330px"></div>
	<div id="menu">
    <ul id="menuu">
    ...
    <div id="prol">
        <div align="center" style="font-size:18px">OBJETIVO
            <p>
        ...
        <div align="center" style="font-size:18px">MISION
            <p>
            Establecer un compromiso con el cliente garantizando su completa satisfaccion.
            </p>
        </div>
        <div align="center" style="font-size:18px">VISION
            <p>
            Establecer un compromiso con el cliente garantizando su completa satisfaccion.
            </p>
        </div>
    ...
    <div class="container" align="center">
       	<div class="row">
            <div class="col-xs-3 col-sm-4 col-md-5">
                <div class="card"> 
                  <div class="front"> 
                   	<img src="images/diseñograf400x300.jpg" />
                  </div> 
                  <div class="back">
                    Back content
                  </div> 
